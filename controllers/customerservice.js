...
exports.readManager = (req,res) => {
    ...
    req.mysqlConnection.query(findNumberQuery, [userEmail], (err, results) => {
        ...
        const findpostQuery = `SELECT postNumber,CustomerService.userNumber,postCategory,postTitle,postContent,createdTime,isAnswered,responderNumber,responseTitle,responseContent,responseTime,email FROM CustomerService, User WHERE User.userNumber = CustomerService.userNumber`;
